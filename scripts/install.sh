...
backup_file "$COMPACT_STARSHIP_FILE" starship-compact.toml

mkdir -p "$GHOSTTY_DIR/themes" "$(dirname -- "$COMPACT_STARSHIP_FILE")"
...
cp "$SOURCE_DIR/starship/starship-compact.toml" "$COMPACT_STARSHIP_FILE"
